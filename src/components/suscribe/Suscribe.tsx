...
export const Suscribe = ({ setFakeSend }: { setFakeSend: Function }) => {
  return (
    <div className="bg-white flex flex-col justify-between pb-10 min-sm:p-0.50 min-sm:p-10 min-sm:rounded-[36px]">
      <div className=" flex flex-col justify-between pb-10 min-sm:p-0.50 min-sm:p-10  ">
